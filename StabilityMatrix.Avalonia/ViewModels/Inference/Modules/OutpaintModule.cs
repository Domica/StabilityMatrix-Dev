...
[ManagedService]
[Transient]
public partial class OutpaintModule : ModuleBase
{
    [ObservableProperty]
    ...
    public OutpaintModule(IInferenceClientManager clientManager)
    {
        Title = "Outpaint";
    }
    ...
    {
        // Outpainting logic will be implemented in the main ViewModel
    }
}
