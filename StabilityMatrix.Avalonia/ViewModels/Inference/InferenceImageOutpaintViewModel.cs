...
namespace StabilityMatrix.Avalonia.ViewModels.Inference {
  ...
  public partial class InferenceImageOutpaintViewModel: InferenceGenerationViewModelBase {
    public
    const string ModuleKey = "ImageOutpaint";
    ...
    public StackCardViewModel StackCardViewModel {
      get;
    }

    public ImageSource ? SelectedImage =>
      StackCardViewModel.GetCard < SelectImageCardViewModel > ()?.ImageSource;
    ...
    public double GenerationProgress {
      ...
      private set {
        ...
        IsProgressIndeterminate = value < 5;
      }
    }
    ...
    private async Task CancelGenerationAsync() {
      if (_generationCancellationTokenSource != null &&
        !_generationCancellationTokenSource.IsCancellationRequested) {
    ...
    protected override void BuildPrompt(BuildPromptEventArgs args) {
      ...
      var padImageNode = new NamedComfyNode < ImageNodeConnection,
        ImageMaskConnection > ("OutpaintPadNode") {
